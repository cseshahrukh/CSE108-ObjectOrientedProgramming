...
public class ShowCarsController {
    ...
    public void init(CarWareHouse cwh)
    {
        ...
        tableView.getColumns().addAll(Registration_Number, YearMadeCol, ColorCol, ColorCol2, ColorCol3,CarMakeCol,CarModelCol,PriceCol,QuantityCol);

    }

    public void Back_button_pressed(ActionEvent actionEvent) {
        try {
            main.showHomePageForManufacturer("Hello Boss");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
